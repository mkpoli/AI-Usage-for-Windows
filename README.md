...
- Mobile Sync with Google Login for syncing this Windows device to AI Usage for Mobile
...
- [Mobile Sync](docs/api/windows-sync.md)
...
- 플러그인 기반 provider 구조
- Google 로그인 기반 Mobile Sync로 Windows 기기 사용량을 AI Usage for Mobile과 동기화
